        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="index.html" class="b-brand">
                    ...
                    <div class="logo logo-lg text-center fw-bold">EEReviewer</div>
                    <img src="../../assets/images/psu.png" alt="" class="logo logo-sm" />
                </a>
            </div>
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="index.php">Dashboard</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="approval.php">Approvals</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="profile.php">Account Settings</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
